            ...
            <Row>
                ...
                <Col className="rightSide" md={9} lg={9} sm={9} xl={9} xs={9}>
                    <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <input name="facilities1" placeholder="write facilities 1:" ref={register} />

                        <hr/>
                        <label >Facilities 2 : </label>
                        <input name="facilities2" placeholder="write facilities 2:" ref={register} />

                        <hr/>
                        <label >Facilities 3: </label>
                        <input name="facilities3" placeholder="write facilities 3" ref={register} />
